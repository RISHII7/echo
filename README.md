...
| `CLERK_SECRET_KEY`        | Clerk secret key, used by the `/clerk-webhook` HTTP action | Yes      |
| `CLERK_WEBHOOK_SECRET`    | Clerk webhook signing secret, verified via `svix`          | Yes      |
