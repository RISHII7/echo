...
- **Dashboard Chat** — operator-facing `ConversationIdView` for replying to widget conversations via the AI Elements chat UI, backed by identity-gated `private/conversations.getOne` and `private/messages` (create/getMany) Convex functions
